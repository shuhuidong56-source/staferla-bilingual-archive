const translations = {
  zh: {
    navSeminars: "研讨班",
    navAnnexes: "附录文献",
    eyebrow: "Jacques Lacan / Freud 文献索引",
    heroTitle: "一个更清晰的 Staferla 双语资料馆",
    heroText: "将原站内容重组为现代双语索引。目前 S1 已开始人工翻译，其余文档保留原文链接与草稿框架。",
    statSeminars: "研讨班",
    statDocs: "文档入口",
    statLangs: "界面语言",
    ...
    manualCountNote: "S1 已人工翻译到第 475 段。",
    ...
    footerText: "资料来自 staferla.free.fr；本站为现代化双语索引界面，源文件链接保留原站地址。",
    source: "原文标题",
    sourcePage: "源页面",
    noResults: "没有匹配结果。",
    word: "Word 文档",
  ...
  en: {
    ...
    navAnnexes: "Annexes",
    eyebrow: "Jacques Lacan / Freud document index",
    heroTitle: "A clearer bilingual Staferla archive",
    heroText: "A modern bilingual index for the original archive. S1 is under manual translation; the remaining documents retain source links and draft shells.",
    ...
    manualCountNote: "S1 has been manually translated through paragraph 475.",
    ...
    footerText: "Content is sourced from staferla.free.fr; this site provides a modern bilingual index while preserving original file links.",
