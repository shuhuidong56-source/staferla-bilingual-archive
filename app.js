const translations = {
  zh: {
    ...
    heroText: "一个面向中文读者的非官方研读网站：重整 Staferla 原站的拉康研讨班、弗洛伊德文集、附录文献与齐泽克阅读入口，提供可搜索索引、中英界面和持续推进的中英译文。目前 S1 已人工翻译到第 763 段，其余文档保留原站链接与译文框架。",
    statSeminars: "研讨班",
    statDocs: "文档入口",
    statLangs: "界面语言",
    ...
    manualCountNote: "S1 已人工翻译到第 763 段。",
  ...
  en: {
    ...
    heroText: "An unofficial study site for Chinese and English readers: it reorganizes the Staferla archive into a searchable index for Lacan's seminars, Freud collections, annex texts, and Žižek reading entries, with bilingual interface labels and ongoing Chinese-English translations. S1 has been manually translated through paragraph 763; the remaining documents keep source links and translation shells.",
    ...
    manualCountNote: "S1 has been manually translated through paragraph 763.",
